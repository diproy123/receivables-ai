...
export const laneLabel = l => ({ AUTO_APPROVE: '✓ Approved', REVIEW: '⟳ Review', MANAGER_REVIEW: 'Manager Review', VP_REVIEW: 'VP Review', CFO_REVIEW: 'CFO Review', BLOCK: '⛔ Blocked' })[l] || l;
export const laneColor = l => l === 'AUTO_APPROVE' ? 'ok' : l === 'BLOCK' ? 'err' : l === 'REVIEW' ? 'info' : 'warn';
