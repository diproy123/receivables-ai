...
OVER_INVOICE_PCT = float(os.environ.get("OVER_INVOICE_PCT", "2"))               # % over PO to flag (F&A-10: tightened from 10% to 2%)
DUPLICATE_DAYS_WINDOW = int(os.environ.get("DUPLICATE_DAYS_WINDOW", "90"))     # days window for duplicate check (F&A-7: extended from 30 to 90)
