...
{icon:'\u2699\uFE0F',label:'Policy-Driven Triage',sub:'Rule-based routing: auto-approve / review / block \u00B7 fully explainable',color:'#dc2626',bg:'rgba(220,38,38,.08)'},
...
<div style="display:grid;grid-template-columns:repeat(6,1fr);gap:2px;background:var(--bd);border-radius:14px;overflow:hidden;border:1px solid var(--bd)">
${[
