...
const sec=(label)=>`<div style="font-size:10px;color:var(--td);font-weight:700;text-transform:uppercase;letter-spacing:.1em;padding:0 16px;margin:18px 0 6px">${label}</div>`;
