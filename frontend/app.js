...
.lp-s{padding:28px 16px 0 !important}
.lp-nav{padding:12px 16px !important}
.lp-hero-grid{grid-template-columns:1fr !important;gap:24px !important}
.lp-hero-grid h1{font-size:30px !important}
.lp-stats-row{gap:12px !important;flex-wrap:wrap !important}
.lp-stats-row>div{min-width:70px !important}
.lp-grid2{grid-template-columns:1fr !important;gap:14px !important}
.lp-grid3{grid-template-columns:1fr !important;gap:12px !important}
.lp-grid2d{grid-template-columns:1fr !important;gap:20px !important;padding:24px 20px !important}
.lp-lang5{grid-template-columns:repeat(5,1fr) !important;gap:4px !important}
.lp-strip{flex-direction:column !important;gap:14px !important;padding:20px 16px !important;text-align:center}
.lp-strip-flow{flex-direction:column !important;gap:6px !important}
.lp-strip-flow svg{transform:rotate(90deg)}
.lp-ft{padding:16px !important;flex-direction:column !important;gap:6px;text-align:center}
.lp-cta-s{padding:28px 16px 36px !important}
.lp-cta-box{padding:28px 20px !important}
.lp-sec-title{font-size:22px !important}
.lp-big-text{font-size:20px !important}
.lp-hero-pipe{display:none !important}
}`;
...
<nav class="lp-nav" style="padding:16px 48px;display:flex;align-items:center;justify-content:space-between;position:relative;z-index:10">
...
<!-- HERO -->
<section class="lp-s">
<div class="lp-hero-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:center">
<div>
...
<div class="lp-stats-row" style="display:flex;gap:24px;font-size:13px;color:var(--td)">
...
<!-- PROBLEM -->
<section class="lp-s">
<div class="lp-grid2d" style="background:linear-gradient(135deg,#0f172a,#1e293b);border-radius:16px;padding:40px;display:grid;grid-template-columns:1fr 1fr;gap:40px;align-items:center">
<div>
...
<div class="lp-big-text" style="font-size:24px;font-weight:800;color:white;margin-bottom:14px;letter-spacing:-.02em;line-height:1.2">AP teams lose 1\u20143% of spend to undetected overcharges, duplicates, and contract violations.</div>
...
<div class="lp-grid2" style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
${[
...
<div class="lp-sec-title" style="font-size:28px;font-weight:800;color:var(--tx);letter-spacing:-.03em">AI where it matters. Rules where you need control.</div>
...
<div class="lp-grid3" style="display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:16px">
${[
...
<div class="lp-sec-title" style="font-size:28px;font-weight:800;color:var(--tx);letter-spacing:-.03em">Every number verified. Every decision auditable.</div>
</div>
<div class="lp-grid2" style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
...
<!-- GLOBAL -->
<section class="lp-s">
<div class="lp-grid2d" style="background:linear-gradient(135deg,#0f172a,#1e293b);border-radius:16px;padding:32px 40px;display:grid;grid-template-columns:1fr 1fr;gap:36px;align-items:center">
<div>
...
<div class="lp-sec-title" style="font-size:22px;font-weight:800;color:white;margin-bottom:10px;letter-spacing:-.02em">Process invoices in ${lc} languages</div>
...
<div class="lp-sec-title" style="font-size:28px;font-weight:800;color:var(--tx);letter-spacing:-.03em">Your data. Your infrastructure. Your rules.</div>
...
<div class="lp-grid3" style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:20px">
${[
...
<div class="lp-strip" style="background:linear-gradient(135deg,#0f172a,#1e293b);border-radius:12px;padding:24px 32px;display:flex;align-items:center;justify-content:space-between;gap:16px">
...
<div class="lp-strip-flow" style="display:flex;gap:8px;align-items:center;flex-shrink:0">
...
<!-- CTA -->
<section class="lp-cta-s" style="padding:48px 48px 56px;max-width:800px;margin:0 auto;text-align:center;position:relative;z-index:10">
<div class="lp-cta-box" style="background:linear-gradient(135deg,var(--ag),#eff6ff);border:1px solid rgba(26,86,219,.12);border-radius:20px;padding:40px 36px">
<div class="lp-sec-title" style="font-size:26px;font-weight:800;color:var(--tx);margin-bottom:10px;letter-spacing:-.02em">See what your AP team is missing.</div>
...
<footer class="lp-ft" style="padding:28px 48px;border-top:1px solid var(--bd);display:flex;justify-content:space-between;align-items:center;position:relative;z-index:10"><div style="font-size:12px;color:var(--td);font-weight:500">\u00A9 2026 AuditLens${ver?' \u00B7 v'+ver:''}</div><div style="font-size:12px;color:var(--td)">Enterprise AP Automation \u00B7 SOX-Ready</div></footer></div>`}
