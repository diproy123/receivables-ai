...
<div style="display:flex;align-items:center;gap:10px"><img src="${LOGO_SM}" width="28" height="28" style="border-radius:7px"><span style="font-size:18px;font-weight:700;letter-spacing:-.03em">AIvoraLabs</span></div>
...
<div style="display:flex;align-items:center;gap:10px;padding:0 20px;margin-bottom:32px">${I.logo}<div><div style="font-size:15px;font-weight:700;letter-spacing:-.02em">AIvoraLabs</div><div style="font-size:10px;color:var(--td);font-weight:500;text-transform:uppercase;letter-spacing:.05em">Receivables AI</div></div></div>
