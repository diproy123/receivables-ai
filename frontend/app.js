...
@media(max-width:768px){.lp-nav{padding:12px 20px !important}.lp-hero{grid-template-columns:1fr !important;gap:28px !important;padding:28px 20px 0 !important}.lp-hero h1{font-size:32px !important}.lp-hero-stats{gap:16px !important;flex-wrap:wrap !important}.lp-section{padding:32px 20px 0 !important}.lp-2col{grid-template-columns:1fr !important;gap:16px !important}.lp-3col{grid-template-columns:1fr !important;gap:12px !important}.lp-lang-grid{grid-template-columns:repeat(5,1fr) !important;gap:4px !important}.lp-dark-strip{flex-direction:column !important;text-align:center;gap:12px !important;padding:20px !important}.lp-dark-2col{grid-template-columns:1fr !important;gap:16px !important}.lp-problem-heading{font-size:20px !important}.lp-ai-title{font-size:22px !important}.lp-cta{padding:32px 20px 40px !important}.lp-cta-inner{padding:28px 20px !important}.lp-footer{padding:20px !important;flex-direction:column;gap:8px;text-align:center}.lp-deploy-flow{flex-direction:column !important;gap:6px !important}.lp-deploy-flow svg{transform:rotate(90deg)}}`;
...
<section class="lp-hero" style="padding:48px 48px 0;max-width:1120px;margin:0 auto;position:relative;z-index:10;display:grid;grid-template-columns:1fr 1fr;gap:48px;align-items:center">
<div>
...
<h1 class="lp-hero" style="font-size:44px;font-weight:800;letter-spacing:-.04em;line-height:1.08;margin-bottom:18px;color:var(--tx)">Catch overcharges<br><span style="background:linear-gradient(135deg,var(--ac),#3b82f6);-webkit-background-clip:text;-webkit-text-fill-color:transparent">before you pay.</span></h1>
...
<div class="lp-hero-stats" style="display:flex;gap:24px;font-size:13px;color:var(--td)">
...
<section class="lp-section" style="padding:56px 48px 0;max-width:1120px;margin:0 auto;position:relative;z-index:10">
<div style="background:linear-gradient(135deg,#0f172a,#1e293b);border-radius:16px;padding:40px;display:grid;grid-template-columns:1fr 1fr;gap:40px;align-items:center" class="lp-dark-2col">
<div>
...
<div class="lp-problem-heading" style="font-size:24px;font-weight:800;color:white;margin-bottom:14px;letter-spacing:-.02em;line-height:1.2">AP teams lose 1\u20143% of spend to undetected overcharges, duplicates, and contract violations.</div>
...
<div class="lp-2col" style="display:grid;grid-template-columns:1fr 1fr;gap:12px">
${[
...
<div class="lp-ai-title" style="font-size:28px;font-weight:800;color:var(--tx);letter-spacing:-.03em">AI where it matters. Rules where you need control.</div>
...
<div class="lp-3col" style="display:grid;grid-template-columns:repeat(3,1fr);gap:14px;margin-bottom:16px">
${[
...
<section class="lp-section" style="padding:48px 48px 0;max-width:1120px;margin:0 auto;position:relative;z-index:10">
...
<div class="lp-2col" style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
...
<!-- ═══ GLOBAL: Languages ═══ -->
<section class="lp-section" style="padding:48px 48px 0;max-width:1120px;margin:0 auto;position:relative;z-index:10">
<div class="lp-dark-2col" style="background:linear-gradient(135deg,#0f172a,#1e293b);border-radius:16px;padding:32px 40px;display:grid;grid-template-columns:1fr 1fr;gap:36px;align-items:center">
<div>
...
<div class="lp-3col" style="display:grid;grid-template-columns:repeat(3,1fr);gap:16px;margin-bottom:20px">
${[
...
<div class="lp-dark-strip" style="background:linear-gradient(135deg,#0f172a,#1e293b);border-radius:12px;padding:24px 32px;display:flex;align-items:center;justify-content:space-between;gap:16px;flex-wrap:wrap">
...
<div class="lp-deploy-flow" style="display:flex;gap:8px;align-items:center;flex-shrink:0">
...
<!-- ═══ CTA ═══ -->
<section class="lp-cta" style="padding:48px 48px 56px;max-width:800px;margin:0 auto;text-align:center;position:relative;z-index:10">
<div class="lp-cta-inner" style="background:linear-gradient(135deg,var(--ag),#eff6ff);border:1px solid rgba(26,86,219,.12);border-radius:20px;padding:40px 36px">
...
<footer class="lp-footer" style="padding:28px 48px;border-top:1px solid var(--bd);display:flex;justify-content:space-between;align-items:center;position:relative;z-index:10"><div style="font-size:12px;color:var(--td);font-weight:500">\u00A9 2026 AuditLens${ver?' \u00B7 v'+ver:''}</div><div style="font-size:12px;color:var(--td)">Enterprise AP Automation \u00B7 SOX-Ready</div></footer></div>`}
