...
${roField('Source',{'claude_api':'Claude AI','manual':'Manual Entry','claude_api_parse_error':'Claude AI (parse error)','claude_api_error':'Claude AI (error)','no_api_key':'No API Key'}[it.extractionSource]||'Claude AI')}
