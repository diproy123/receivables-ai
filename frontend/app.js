...
${m==='register'?`<div style="margin-bottom:24px"><label style="font-size:12px;font-weight:600;color:rgba(255,255,255,.5);display:block;margin-bottom:6px;text-transform:uppercase;letter-spacing:.06em">Role</label><select id="auth-role" style="width:100%;padding:12px 14px;border:1px solid rgba(255,255,255,.1);border-radius:10px;font-size:14px;font-family:var(--ft);background:rgba(255,255,255,.04);color:white;outline:none"><option value="analyst">AP Analyst</option><option value="manager">AP Manager</option><option value="vp">VP Finance</option><option value="cfo">CFO</option></select><div style="font-size:11px;color:rgba(255,255,255,.3);margin-top:6px">First user is automatically promoted to CFO</div></div>`:''}
